...
class CfgVehicles
{
    ...
    class LFPG_BatteryMedium : Inventory_Base
    {
        ...
        // energyStorageMax MUST match LFPG_BATTERY_MEDIUM_CAPACITY (200000).
        class EnergyManager
        {
    ...
    class LFPG_BatteryLarge : Inventory_Base
    {
        ...
        // EnergyManager: drives vanilla inventory white charge bar.
        // All actual energy logic is handled by LFPG timer + SyncCompEM().
        // energyStorageMax MUST match LFPG_BATTERY_LARGE_CAPACITY (1000000).
        class EnergyManager
        {
            energyStorageMax = 1000000;
            energyAtSpawn = 0;
            convertEnergyToQuantity = 1;
            updateInterval = 0;
            isPassiveDevice = 1;
